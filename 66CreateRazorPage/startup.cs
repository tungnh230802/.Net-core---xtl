...
public class startup
{
    ...
    public void ConfigureServices(IServiceCollection service)
    {
        ...
        {
            // đổi tên thư mục mặc định của razor page
            option.RootDirectory = "/Pages";
            // option.Conventions.AddPageRoute("/FirstPage", "/trangdau");
        });

        service.Configure<RouteOptions>(config =>
        {
